...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260323071513_AddPrescriptionStatus') THEN
    ALTER TABLE appointments ADD prescription_status character varying(20);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260323071513_AddPrescriptionStatus') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260323071513_AddPrescriptionStatus', '9.0.1');
    END IF;
END $EF$;
COMMIT;
