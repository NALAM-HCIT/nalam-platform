...
import { LayoutGrid, Users, Settings, User } from 'lucide-react-native';
...
export default function AdminTabsLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle, tabBarShowLabel: false }}>
      ...
      <Tabs.Screen
        name="users"
        options={{ tabBarIcon: ({ focused }) => <TabIcon icon={Users} label="Users" focused={focused} /> }}
      />
      <Tabs.Screen
        name="settings"
        options={{ tabBarIcon: ({ focused }) => <TabIcon icon={Settings} label="Settings" focused={focused} /> }}
      />
      <Tabs.Screen
        name="profile"
