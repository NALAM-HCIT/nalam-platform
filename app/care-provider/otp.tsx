...
export default function CareProviderOTPScreen() {
  ...
  return (
    <View className="flex-1 bg-surface">
      ...
      <View className="absolute bottom-32 -left-16 w-64 h-64 bg-primary/5 rounded-full" />
      ...
      <View className="flex-1 items-center justify-center px-6">
        <View className="w-full max-w-md">
          ...
          <View className="bg-white rounded-3xl p-8" style={Shadows.presence}>
            {error ? (
                ...
                <TextInput
                  ...
                  className={`w-12 h-14 rounded-xl text-center text-xl font-extrabold border ${
                    digit
                      ...
                      : 'bg-slate-50 border-slate-200 text-midnight'
                  }`}
