...
import { LayoutGrid, CalendarCheck, Users, MessageSquare, User } from 'lucide-react-native';
...
export default function DoctorTabsLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle, tabBarShowLabel: false }}>
      ...
      <Tabs.Screen
        name="messages"
        options={{ tabBarIcon: ({ focused }) => <TabIcon icon={MessageSquare} label="Messages" focused={focused} /> }}
      />
      <Tabs.Screen
        name="directory"
        options={{ tabBarIcon: ({ focused }) => <TabIcon icon={CalendarCheck} label="Schedule" focused={focused} /> }}
      />
      <Tabs.Screen
        name="profile"
