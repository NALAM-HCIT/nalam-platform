...
export default function PharmacistLoginScreen() {
  const router = useRouter();
  const { setPhone, setRole } = useAuthStore();
        ...
        <View className="flex-1 bg-[#EEF3FF] rounded-t-[32px] -mt-8 z-10">
          ...
          >
            ...
            <Pressable className="items-center mb-6">
              <Text className="text-primary font-semibold text-sm">Login with Employee ID</Text>
            </Pressable>
            ...
            <View className="flex-row gap-3 p-4 bg-white/70 rounded-2xl border border-blue-100">
              ...
              <Text className="text-xs text-slate-500 flex-1 leading-relaxed">
                Institutional Access Only. This portal is monitored by the Hospital Administrator. For login issues, please contact IT Support.
              </Text>
            </View>
