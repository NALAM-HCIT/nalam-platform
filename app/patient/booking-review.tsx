      ...
      >
        ...
        <View className="mx-5 mt-4">
          <View className="flex-row items-center justify-between mb-3">
            <Text className="text-base font-bold text-midnight">Patient Details</Text>
          ...
          <View className="flex-row items-center gap-4 bg-white p-4 rounded-2xl" style={Shadows.card}>
            ...
            <View>
              <Text className="font-bold text-[15px] text-midnight">John Doe</Text>
              <Text className="text-slate-400 text-xs mt-0.5">Age: 32 • Male • UHID: NLM-8923</Text>
            </View>
          </View>
        </View>
        ...
        <View className="mx-5 mt-5">
          ...
          <View className="bg-white p-4 rounded-2xl" style={Shadows.card}>
            <View className="gap-2.5">
              ...
              <View className="flex-row justify-between items-center">
                <Text className="text-midnight font-bold text-base">Total Payable</Text>
