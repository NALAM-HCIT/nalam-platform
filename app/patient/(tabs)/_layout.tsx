...
import { LayoutGrid, CalendarCheck, FolderOpen, BriefcaseMedical, User } from 'lucide-react-native';
...
export default function PatientTabsLayout() {
  return (
    <Tabs screenOptions={{ headerShown: false, tabBarStyle, tabBarShowLabel: false }}>
      ...
      <Tabs.Screen
        name="records"
        options={{ tabBarIcon: ({ focused }) => <TabIcon icon={FolderOpen} label="Records" focused={focused} /> }}
      />
      <Tabs.Screen
        name="pharmacy"
        options={{ tabBarIcon: ({ focused }) => <TabIcon icon={BriefcaseMedical} label="Pharmacy" focused={focused} /> }}
      />
      <Tabs.Screen
        name="profile"
